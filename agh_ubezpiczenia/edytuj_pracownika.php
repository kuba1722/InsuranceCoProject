...
<body>
	...
	error_reporting(E_ALL ^ E_NOTICE);
		if ( isset( $_POST['edytuj'] ) )
		{
			...
			if ( empty( $data_missing ) )
			{
				...
				$zapytanie = "SELECT pracownicy.ID, pracownicy.imie, pracownicy.nazwisko, pracownicy.pesel,pracownicy.numer_telefonu, pracownicy.adres_zamieszkania, pracownicy.kod_pocztowy, pracownicy.seria_dowodu, pracownicy.email FROM pracownicy WHERE ID='$typ1'";	
	...
	<table>
		<b>Edycja:</b><br>
		<tr>
			<p><td>Podzaj ID pracownika do edytowanego:</td> 
