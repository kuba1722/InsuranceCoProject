...
<body>
	<?php
		if ( isset( $_POST['dodaj'] ) )
		{
			...
			if( empty( $_POST['typ10'] ) ) $data_missing[] = 'typ10';
				else $typ10 = trim( $_POST['typ10'] );
			if( empty( $_POST['typ11'] ) ) $data_missing[] = 'typ11';
				else $typ11 = trim( $_POST['typ11'] );
			if( empty( $_POST['typ12'] ) ) $data_missing[] = 'typ12';
				else $typ12 = trim( $_POST['typ12'] );
			if ( empty( $data_missing ) )
			{
				...
				$zapytanie = "INSERT INTO rejestracja (id_klienta, imie, nazwisko, pesel, miejsce_urodzenia, kraj_urodzenia, obywatelstwo, seria_dowodu, numer_telefonu, email, adres_zamieszkania, kod_pocztowy, login) VALUES (NULL, '$typ1', '$typ2', '$typ3', '$typ4', '$typ5', '$typ6', '$typ7', '$typ8', '$typ9', '$typ10', '$typ11', '$typ12')";
	...
	<form action="rejestracja_dodaj.php" method="post">
	<table>
		<b>Rejestracja:</b><br>
		<tr>
			<p><td>Imie:</td> 
		...
		<tr>
		<p><td>miejsce_urodzenia: </td>
			<td><input type="text" name="typ4" size="30" value="" /> </td>
		</p>
		</tr>
		
		<tr>
		<p><td>kraj_urodzenia:</td> 
			<td><input type="text" name="typ5" size="30" value="" /> </td>
		</p>
		</tr>
		
		<tr>
		<p><td>obywatelstwo:</td> 
			<td><input type="text" name="typ6" size="30" value="" /> </td>
		</p>
		</tr>
		...
		<p><td>numer_telefonu:</td> 
			<td><input type="int" name="typ8" size="30" value="" /></td> 
		</p>
		</tr>
		
		<tr>
		<p><td>email:</td> 
			<td><input type="text" name="typ9" size="30" value="" /></td> 
		</p>
		</tr>
		
		<tr>
		<p><td>adres_zamieszkania: </td>
			<td><input type="text" name="typ10" size="30" value="" /></td> 
		</p>
		</tr>
		
		<tr>
		<p><td>kod_pocztowy: </td>
			<td><input type="text" name="typ11" size="30" value="" /></td> 
		</p>
		</tr>
		
		<tr>
		<p><td>login: </td>
			<td><input type="text" name="typ12" size="30" value="" /> </td>
		</p>
		</tr>
